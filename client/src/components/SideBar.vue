<template>
  <div class="" id = "sidebarActual">
    <nav id="sidebar">
      ...
      <b-sidebar id="sidebar-1" title="Timeline" bg-variant="dark" text-variant="light" backdrop backdrop-variant="dark" width="20%" no-header-close shadow>
        <template #footer>
        ...
        <div id = "sidebarComponents" class="px-3 py-2 w-100 h-100" >
          ...
          <div>
            <b-button id = "statistics" v-b-toggle.statisticsCollapse variant="light" class = "w-75" v-on:click="getStatistics()">Statistics</b-button>
